...
exports.RUBRIC_EVALUATION = exports.SYSTEM_PROMPT_EVALUATION = exports.SYSTEM_PROMPT_INTERVIEWER = void 0;
exports.buildInterviewerContext = buildInterviewerContext;
exports.buildEvaluationPrompt = buildEvaluationPrompt;
exports.SYSTEM_PROMPT_INTERVIEWER = `You are a professional AI interviewer. Your role is to conduct a fair, structured interview.
...
exports.SYSTEM_PROMPT_EVALUATION = `You are an evaluation engine for interview answers. You must output ONLY valid JSON. Do not include any text outside the JSON.
...
`;
function buildInterviewerContext(priorSummary) {
    if (!priorSummary)
        return '';
    return `Prior context (summarized): ${priorSummary}\n\n`;
}
function buildEvaluationPrompt(question, answer, competencyIds) {
